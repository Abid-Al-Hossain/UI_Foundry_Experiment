    ...
    <div className="space-y-4">
      ...
      <SectionCard title="Limit & Layout">
        <div className="space-y-4">
          ...
          {/* Simple Segmented Control for Direction (Row/Col) */}
          <div>
      ...
      <div className="rounded-xl border border-blue-500/20 bg-blue-500/10 p-4 text-sm text-blue-600 dark:text-blue-400">
        <strong>👀 Preview Note:</strong> Check the preview panel to see 5
        duplicate avatars stacked with these settings.
      </div>
    </div>
  );
}
