...
</head><body><div class="card">Tabs</div></body></html>`;
}

export default function tabsGalleryPage() {
  const srcDoc = useMemo(() => buildMiniPreview(), []);
  return (
    <GalleryPageTemplate
      title="Tabs"
      description="Switch between views."
      playgroundLink="/components/tabs/playground"
      playgroundTitle="Tabs Studio"
