...
</head><body><div class="card">Video Player</div></body></html>`;
}

export default function VideoplayerGalleryPage() {
  const srcDoc = useMemo(() => buildMiniPreview(), []);
  return (
    <GalleryPageTemplate
      title="Video Player"
      description="Play video files."
      playgroundLink="/components/video-player/playground"
      playgroundTitle="Video Player Studio"
