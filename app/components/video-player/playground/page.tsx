...
export default function Page() {
  ...
  const applyPreset = (preset: StudioPreset) => { setState({ ...DEFAULT_VIDEOPLAYER_STATE, ...(preset.state as Partial<VideoPlayerState>) }); setActivePresetId(preset.id); setPreviewResetKey((value) => value + 1); };
