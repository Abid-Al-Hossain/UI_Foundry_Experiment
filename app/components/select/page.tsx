...
</head><body><div class="card">Select / Dropdown</div></body></html>`;
}

export default function selectGalleryPage() {
  const srcDoc = useMemo(() => buildMiniPreview(), []);
  return (
    <GalleryPageTemplate
      title="Select / Dropdown"
      description="Pick a value from a list."
      playgroundLink="/components/select/playground"
      playgroundTitle="Select / Dropdown Studio"
