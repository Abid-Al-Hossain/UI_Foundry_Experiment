...
export default function MetadataSection({ state, update }: Props) {
  return <SectionCard title="Metadata" subtitle="Metadata controls for native settings generation.">
...
<Select label="Role" value={state.role} options={[
  "form",
]} onChange={(value) => update("role", value as SettingsPanelState["role"])} />
