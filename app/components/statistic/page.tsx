...
</head><body><div class="card">Statistic</div></body></html>`;
}

export default function statisticGalleryPage() {
  const srcDoc = useMemo(() => buildMiniPreview(), []);
  return (
    <GalleryPageTemplate
      title="Statistic"
      description="Display key numbers and metrics."
      playgroundLink="/components/statistic/playground"
      playgroundTitle="Statistic Studio"
