...
</head><body><div class="card">Container</div></body></html>`;
}

export default function containerGalleryPage() {
  const srcDoc = useMemo(() => buildMiniPreview(), []);
  return (
    <GalleryPageTemplate
      title="Container"
      description="Centered content wrapper."
      playgroundLink="/components/container/playground"
      playgroundTitle="Container Studio"
