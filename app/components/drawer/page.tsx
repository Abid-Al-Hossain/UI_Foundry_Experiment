...
</head><body><div class="card">Drawer</div></body></html>`;
}

export default function drawerGalleryPage() {
  const srcDoc = useMemo(() => buildMiniPreview(), []);
  return (
    <GalleryPageTemplate
      title="Drawer"
      description="Slide-out panels."
      playgroundLink="/components/drawer/playground"
      playgroundTitle="Drawer Studio"
