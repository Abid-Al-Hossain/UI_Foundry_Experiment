...
// Compact dropdown with the same prop shape as Segmented — used for preset
// FILTERS so a many-option control doesn't collapse into a tall one-per-row
// stack in the narrow filter grid.
