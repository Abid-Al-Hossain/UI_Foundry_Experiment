...
import CalendarSection from "../_section/CalendarSection";
...
export default function Page() {
  ...
  const controls = (
    <>
      ...
      {activeSection === "calendar" && <CalendarSection state={state} update={update} />}
  ...
  return (
    <AppShell contentOverflow="hidden">
      <PlaygroundLayout title="Date Picker Studio" headerActions={headerActions} controls={controls} preview={output} />
