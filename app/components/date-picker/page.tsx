...
</head><body><div class="card">Date Picker</div></body></html>`;
}

export default function datepickerGalleryPage() {
  const srcDoc = useMemo(() => buildMiniPreview(), []);
  return (
    <GalleryPageTemplate
      title="Date Picker"
      description="Select a date or range."
      playgroundLink="/components/date-picker/playground"
      playgroundTitle="Date Picker Studio"
