...
</head><body><div class="card">Header</div></body></html>`;
}

export default function headersGalleryPage() {
  const srcDoc = useMemo(() => buildMiniPreview(), []);
  return (
    <GalleryPageTemplate
      title="Header"
      description="Page headers."
      playgroundLink="/components/headers/playground"
      playgroundTitle="Header Studio"
