...
</head><body><div class="card">Table</div></body></html>`;
}

export default function tablesGalleryPage() {
  const srcDoc = useMemo(() => buildMiniPreview(), []);
  return (
    <GalleryPageTemplate
      title="Table"
      description="Rows and columns of data."
      playgroundLink="/components/tables/playground"
      playgroundTitle="Table Studio"
