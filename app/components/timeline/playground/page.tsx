...
export default function Page() {
  ...
  const applyPreset = (preset: StudioPreset) => { setState({ ...DEFAULT_TIMELINE_STATE, ...(preset.state as Partial<TimelineState>) }); setActivePresetId(preset.id); setPreviewResetKey((value) => value + 1); };
