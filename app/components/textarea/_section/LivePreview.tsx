...
export default function LivePreview({ state }: { state: TextareaState }) {
  ...
  const textareaStyle: React.CSSProperties = {
    ...
    whiteSpace: state.whiteSpace as any,
    overflowWrap: state.overflowWrap as any,
    wordBreak: state.wordBreak as any,
    ...
    scrollbarWidth: state.scrollbarWidth as any,
  ...
  const pseudoId = "textarea-preview";
  const cssString = `
    #${pseudoId}:focus {
  ...
  return (
    ...
    >
      ...
      <div style={{ width: "100%", maxWidth: 480 }}>
        ...
        {state.charCount && state.maxLength > 0 && (
          <p
            style={{
              marginTop: 4,
              fontSize: 11,
