...
</head><body><div class="card">File Upload</div></body></html>`;
}

export default function fileuploadGalleryPage() {
  const srcDoc = useMemo(() => buildMiniPreview(), []);
  return (
    <GalleryPageTemplate
      title="File Upload"
      description="Drag & drop or click to upload files."
      playgroundLink="/components/file-upload/playground"
      playgroundTitle="File Upload Studio"
