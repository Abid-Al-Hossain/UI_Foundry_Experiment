...
import { DEFAULT_FILEUPLOAD_STATE, FILEUPLOAD_PRESETS } from "../_data/FileUploadPresets";
...
export default function Page() {
  ...
  const activePresetId = useMemo(() => findActivePresetId(state, DEFAULT_FILEUPLOAD_STATE, FILEUPLOAD_PRESETS), [state]);
